...
The idea for using `put` as the name instead of something else is based on the
explanation of how Git was named, but instead of "global information tracker" it
is the "personal use tracker".
